...
@media (max-width: 62rem) {
  ...
  .dh-schools-page__directory { padding-inline: 2rem; }
  .dh-schools-page__hero-grid { grid-template-columns: 1fr; }
  .dh-schools-page__results-header { flex-direction: column; align-items: flex-start; }
  .dh-schools-page__results-actions { width: 100%; justify-content: space-between; }
  .dh-schools-page__grid { grid-template-columns: 1fr; }
}

@media (max-width: 34rem) {
  .dh-schools-page__hero,
  .dh-schools-page__directory { padding-inline: 1.25rem; }
  .dh-schools-page__results-actions { flex-direction: column; align-items: stretch; }
  .dh-schools-page__sort { width: 100%; }
}
</style>
